  ...
  return (
    <div className="w-full flex flex-col p-5 bg-gray-300">
      ...
      <div className="flex flex-col gap-5">
        <div className="bg-white border rounded-md w-full p-4 border border-slate-300 drop-shadow-sm">
        ...
        <div className="flex gap-5">
          <div className="bg-white border rounded-md w-1/2 p-4 border border-slate-300 drop-shadow-sm">
            <p className="text-md">Welcome to the Dashboard</p>
            <p className="text-sm text-gray-500">
              We've prepare some links to get you started
            </p>
