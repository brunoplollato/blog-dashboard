  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor('categories', {
        header: 'Categories',
        cell: (info) =>
          info.row.original.categories.map((category, i) => (
            <span
    ...
    <div className="w-full flex flex-col p-5 bg-gray-300">
      <Breadcrumb
        items={[
          ...
          { text: 'posts', links: '/dashboard/posts' },
          { text: 'all posts', link: '' },
        ]}
      />
          ...
          <div className="bg-white border rounded-md p-4 border-slate-300 drop-shadow-sm">
            <div className="flex justify-between gap-5">
              ...
              <Link
                ...
                className="group relative w-full h-10 flex items-center justify-center px-4 border border-transparent text-sm font-medium rounded-md text-white bg-purple-700 hover:bg-purple-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 mt-5 w-32"
              >
