...
function EditPost() {
    ...
    const { getPostById, updatePost } = (0, usePost_1.default)();
    ...
    const handleSubmit = async () => {
        ...
        if (isValid) {
            ...
            return (res === null || res === void 0 ? void 0 : res.status)
                ? react_toastify_1.toast.success(res.message) && navigate('/dashboard/posts')
